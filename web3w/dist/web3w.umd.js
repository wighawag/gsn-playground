(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('@ethersproject/wallet'), require('@ethersproject/providers'), require('@ethersproject/contracts')) :
    typeof define === 'function' && define.amd ? define(['@ethersproject/wallet', '@ethersproject/providers', '@ethersproject/contracts'], factory) :
    (global = global || self, global.web3w = factory(global.wallet, global.providers, global.contracts));
}(this, (function (wallet, providers, contracts) { 'use strict';
      ...
      probing = new Promise(async (resolve, reject) => {
        ...
        try {
          ...
          if (ethereum) {
            ...
            _builtinEthersProvider = proxyWeb3Provider(new providers.Web3Provider(ethereum), _observers);
...
//# sourceMappingURL=web3w.umd.js.map

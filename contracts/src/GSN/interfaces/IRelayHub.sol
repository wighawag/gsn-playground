...
interface IRelayHub {
    ...
    event Penalized(address indexed relayWorker, address sender, uint256 reward);
    ...
    enum RelayCallStatus {OK, RelayedCallFailed, PreRelayedFailed, PostRelayedFailed, RecipientBalanceChanged}
    ...
    ) external view returns (bool success, string memory returnValue);
